...
def main():
    ...
    pool = []
    pool.append(brm(\
        stat=[25,30,5,35],equip=['4t21','chest','waist'],talent=['black','ht'],ver='ptr', prate=0.44,mode='n',t20rate = 0.4 \
        ))
    pool.append(brm(\
        stat=[25,30,5,35],equip=['4t21','chest','waist'],talent=['black','ed'],ver='ptr', prate=0.44,mode='n', t20rate=0.4 \
        ))
