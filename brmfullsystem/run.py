...
def main():
    ...
    pool = []
    pool.append(brm(\
        stat=[20,33,5,35],equip=['4t19','2t20','ring','waist'],talent=['black','ht'],ver='ptr', prate=0.44,mode='star', test=0 \
        ))
    pool.append(brm(\
        stat=[20,33,5,35],equip=['4t19','2t20','ring','waist'],talent=['black','ht'],ver='ptr', prate=0.44,mode='star',test=1 \
        ))
