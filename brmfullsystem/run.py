...
#    return
    ...
    pool = []
    pool.append(brm(\
        stat=[25,30,5,30],equip=['4t19','2t20','waist','ring'],talent=['black','ht'],ver='ptr', prate=0.44,mode='gd' \
        ))
    pool.append(brm(\
        stat=[25,30,5,30],equip=['4t19','2t20','waist','wrist'],talent=['black','ht'],ver='ptr', prate=0.44,mode='gd' \
        ))
    test2(pool)
   # pool.append(brm(\
